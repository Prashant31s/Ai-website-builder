...
const transformOptions = [
    ...
    { label: "Shadow", value: "shadow", icon: <Images />, transformation: 'e-dropshadow' },
...
function ImageSettingSection({ selectedEl }: Props) {
    ...
    const saveUploadedFile = async() =>{
        if(selectedImage){
            ...
            console.log("image redfff", imageRef) 
            // @ts-ignore
    ...
    return (
        <div className="w-96 shadow p-4 space-y-4">
            ...
            <Button className="w-full" onClick={GenrateAiImage} disabled ={ loading}>
